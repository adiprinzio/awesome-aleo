...
- [zkDrop] (https://github.com/4sm-ops/zkDrop/) - Tool for file sharing and collaboration between addresses. Private, easy-to-use, and enables you to store, encrypt, and share multimedia files on-chain.
